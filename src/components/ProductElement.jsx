...
const ProductElement = ({
    ...
    return (
        <>
            ...
            >
                <div className="w-full max-w-sm bg-base-200 rounded-lg shadow ">
                    <a href="#">
                        <img
                            className="p-4 rounded-lg w-full h-72 object-cover object-center"
                            src={image}
                            alt={name}
                        />
                    </a>
                    <div className="px-5 pb-5">
                        <a href="#">
                            <h5 className="text-xl font-semibold tracking-tight text-accent-content">
                                {name}
                            </h5>
                            {/* <p className="text-accent-content">{category}</p> */}
                        </a>
